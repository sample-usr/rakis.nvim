...
function M.get(options, p)
  ...
  local highlights = {
    ...
    TelescopeMatching = { fg = p.water },
  }

  if borderless_telescope then
    highlights.TelescopeBorder = { fg = p.bloom, bg = p.bg }
    highlights.TelescopeNormal = { bg = p.bg }
    highlights.TelescopePreviewBorder = { fg = p.bloom, bg = p.bg }
    ...
    highlights.TelescopeResultsBorder = { fg = p.bloom, bg = p.bg }
