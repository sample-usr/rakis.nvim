...
function M.setup()
  ...
  theme.highlights = {
    ...
    Directory = { fg = c.magenta500 }, -- directory names (and other special names in listings)
    DiffAdd = { fg = c.green700, bg = c.base02, bold = true }, -- diff mode: Added line |diff.txt|
    DiffChange = { fg = c.yellow700, bg = c.base02, bold = true }, -- diff mode: Changed line |diff.txt|
    DiffDelete = { fg = c.red700, bg = c.base02, bold = true }, -- diff mode: Deleted line |diff.txt|
    ...
    LineNr = { fg = c.magenta900, bg = options.transparent and c.none or c.bg }, -- Line number for ":number" and ":#" commands, and when 'number' or 'relativenumber' option is set.
    CursorLineNr = { fg = c.orange500, sp = c.base1 }, -- Like LineNr when 'cursorline' or 'relativenumber' is set for the cursor line.
    MatchParen = { fg = c.magenta100, bg = c.magenta500, bold = true }, -- The character under the cursor or just before it, if it is a paired bracket, and its match. |pi_paren.txt|
    ...
    Search = { fg = c.yellow700, reverse = true }, -- Last search pattern highlighting (see 'hlsearch').  Also used for similar items that need to stand out.
    ...
    Identifier = { fg = c.magenta100, style = options.styles.variables }, -- (preferred) any variable name
    ...
    Operator = { fg = c.magenta700 }, -- "sizeof", "+", "*", etc.
    ...
    ["@operator"] = { fg = c.magenta700 }, -- For any operator: `+`, but also `->` and `*` in C.
    ...
    -- Illuminate
    illuminatedWord = { bg = c.magenta900 },
    illuminatedCurWord = { bg = c.magenta900 },
    IlluminatedWordText = { bg = c.magenta900 },
    ...
    MiniIndentscopeSymbol = { fg = c.magenta700, nocombine = true },
